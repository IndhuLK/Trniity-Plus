      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div data-aos="fade-right">
          <div className="flex items-center gap-3 text-green-700 font-semibold">
            ...
            <MoreHorizontal className="w-8 h-8 text-green-700" />
          </div>
          <h2
          ...
          <p
            className="text-gray-600 mb-6 leading-loose"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            Trinity Plus Social Trust is a nonprofit dedicated to holistic
            community development. Our focus areas include education, healthcare,
            women empowerment, agriculture, and livelihood training. We believe
            that lasting change comes from empowering individuals and communities
            to stand strong and self-reliant.
          </p>
          <a
            href="/about"
