    ...
    <div className="font-family">
      ...
      >
        ...
        <div className="relative z-10 px-4" data-aos="zoom-in">
          ...
          <p className="md:text-lg md:px-50 text-sm max-w-4xl leading-loose">
      ...
      {/* Donate Now */}
      <section
        className="flex flex-col md:flex-row items-center justify-center max-w-6xl mx-auto p-6 gap-8 py-10"
        data-aos="fade-up"
      >
        {/* Left Side - Image */}
        ...
        <div className="w-full md:w-1/2 text-center md:text-left" data-aos="fade-left">
          <p className="text-gray-700 text-base mb-6 leading-loose">
            Every contribution you make has the power to change lives. Your
            generosity helps provide education, healthcare, and livelihood
            opportunities for those in need, paving the way for a brighter
            tomorrow. By giving today, you're not just donating — you're
            investing in a future filled with hope, dignity, and opportunity.
          </p>

          <button
            className="bg-gradient-to-r from-green-900 to-green-600 text-white px-10 py-3 rounded-full font-medium flex items-center mx-auto gap-2 hover:shadow-md transition cursor-pointer"
            data-aos="zoom-in"
          >
            Donate Now
          </button>
      ...
      <section className="py-12 bg-white text-center" data-aos="fade-up">
        ...
        <p className="max-w-3xl mx-auto text-gray-600 mb-8">
          Your donation directly supports programs that bring real change — from
          providing meals and healthcare to skill development and women
          empowerment. Every rupee is carefully utilized to create lasting
          impact in the lives of individuals and communities who need it the
          most.
        </p>

        {/* Box with 4 Features */}
        <div
          className="border border-green-600 rounded-lg p-6 max-w-4xl mx-auto"
          data-aos="zoom-in"
        >
