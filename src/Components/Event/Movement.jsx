      ...
      <div className="max-w-6xl mx-auto py-12 px-6">
        <div className="grid md:grid-cols-2 items-center gap-8">
          ...
          <div className="relative w-full flex justify-center">
            {/* Green Ellipse Shape (background) */}
            <img
              src={ellipse} // Your ellipse image (green shape)
              alt="Ellipse Shape"
            ...
            {/* Big Image */}
            <img
              src={Image1} // Replace with big background image
              alt="Community Event"
            ...
            <img
              src={Image2} // Replace with small overlapping image
              alt="Handshake"
